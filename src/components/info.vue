                                    ...
                                    <v-flex xs9 text-sm-left>
                                        ...
                                        <v-divider></v-divider>
                                         <v-layout style="width:100%">
                                            <v-flex  v-for="ermoAsjad in itemsErmo"  d-inline-flex :key="ermoAsjad.name" >
                            ...
                            <v-container fluid grid-list-lg>
                                ...
                                <v-flex xs9>
                                    ...
                                    <div class="headline">Jane  <span style="float:right; color:red"> {{janeKokku}} €</span></div>
                                        <v-divider></v-divider>
                                        <v-layout style="width:100%">
                                            <v-flex  v-for="item in itemsJane" d-inline-flex :key="item.name">
                                                <v-card flat style="padding:10px;">
        ...
        .then(response => {
          ...
          if (users[i] == "Ermo") {
            vm.itemsErmo.push(
              ...
              {
                hind: parseFloat(res.meelelahutus).toFixed(2),
                name: "MEELELAHUTUS"
              },
